    ...
    public List<BookingResponse> getAllBookingsOfUser(Long bookerId, BookingStateDto state) {
        ...
        switch (state) {
            case ALL:
                ...
                break;
            case CURRENT:
                bookings = bookingRepository.findAllByBooker_IdAndStartIsBeforeAndEndIsAfterOrderByStartAsc(bookerId, now, now);
                break;
            case PAST:
    ...
    public List<BookingResponse> getAllBookingsOfOwner(Long ownerId, BookingStateDto state) {
        ...
        switch (state) {
            case ALL:
                ...
                break;
            case CURRENT:
                bookings = bookingRepository.findAllByItem_Owner_IdAndStartIsBeforeAndEndIsAfterOrderByStartAsc(ownerId, now, now);
                break;
            case PAST:
